...
<form action="" method="POST">  
  <div class="container">  
  <center>  <h2>REVIEW FORM 2</h2> </center>  
  <hr>  
...
<input type="text" name="c" placeholder="Synopsis" size="15"required />  <br> 
...
<div>  
    <button type="submit" name="submit" class="registerbtn">Submit</button>  
	 <button type="View Data" name="View Data" class="register1"><a href="TY1.php" >View Data</a></button>  
...
if(isset($_POST['submit']))
{
	 ...
	 $c=$_POST['c'];
	 $d=$_POST['d'];
	 $query="INSERT INTO `r2`(`GroupNo`, `StudentName`, `Synopsis`, `ReviewMarks`) VALUES('$a','$b','$c','$d')";
