...
if(isset($_POST['submit'])){
    ...
    $select_event_name = mysqli_query($conn, "SELECT roll_n FROM `bsc_it_ty_rev2` WHERE roll_n = '$roll_n'") or die('query failed');
    ...
    if(mysqli_num_rows($select_event_name) > 0){
        echo
			...
			document.location.href = 'fill_mark_rev2.php';
			</script>
			";
     }else{
        $add_event_query = mysqli_query($conn, "INSERT INTO `bsc_it_ty_rev2`(roll_n, rev2) VALUES('$roll_n', '$rev2')") or die('query failed');
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div>
        <h1 class="main_head"><span>B.Sc. I.T (T.Y.) Second Review</span></h1>
    </div>
    ...
    <table border=1>
        ...
        <tr>
            ...
            <form action="" method="post">
                ...
                <td><input type="number" class="inp" name="rev2" id=""></td>
    ...
    <div class="container">
        <a href="fill_mark_rev3.php" class="input-btn">Fill the marks of next review</a>
    </div>
